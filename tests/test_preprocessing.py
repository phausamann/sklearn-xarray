    ...
    X_ds = xr.Dataset(
        {
            ...
            "var_2": (["feat_2", "sample"], np.random.random((5, 100))),
        },
...
def test_resample():
    ...
    X_da = xr.DataArray(
        np.random.random((100, 10)),
        coords={
            "sample": pd.timedelta_range(0, periods=100, freq="10ms"),
            "feature": range(10),
        },
        dims=("sample", "feature"),
    )
    ...
    X_ds = xr.Dataset(
        {
            ...
            "var_2": (["sample", "feat_1"], np.random.random((100, 10))),
        },
        coords={
            "sample": range(100),
            "feat_1": range(10),
